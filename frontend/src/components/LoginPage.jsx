...
export default function LoginPage({ onLoginSuccess }) {
  ...
  return (
    <div className="relative w-full h-screen bg-slate-950 flex items-center justify-center p-4">
      <CosmicBackground intensity={1.5} />
      
      <div className="z-10 w-full max-w-md bg-slate-900/60 backdrop-blur-xl border border-slate-700 p-8 rounded-2xl shadow-2xl animate-fade-in">
